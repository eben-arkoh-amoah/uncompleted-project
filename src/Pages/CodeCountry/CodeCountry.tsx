...
export const CodeCountryPage = () => {
const {code} = useParams();

const [loading, setLoading] = useState(false);
const [country, setCountry] = useState({} as CountryTs);
...
setLoading(true);
let country =  await api.getCountryByCode(param);
setCountry(country);
console.log(country);
setLoading(false);
}
    ...
    return(
        <div className="CountryPage">
           ...
           {!loading &&
                ...
                currencie = {country.currencies && country.currencies}
